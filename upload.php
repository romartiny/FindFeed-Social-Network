...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        <p class='upload_picture_text'>Upload your new picture<p><br /><br />
	        <input type="file" id="image" name="image" style="width:200px; height:30px;" /><br /><br />
	        <input type="submit" value="Submit" style="width:85px; height:25px; background-color: #2e2e2e; border-radius: 20px; color: #FFFFFF;" />
	    </form><br /><br />
	</div> <!-- Form-->  
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#181716; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
	           <p style="margin:0px; padding:0px; color:#444; font-size:18px;">          
	                <b style='color: #FFFFFF;'>Crop Profile Image</b><br /><br />
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="submit" value="Save" style="width:50px; height:30px;"   />
					<div id="CropImageForm2" style="width:100px; height:30px; float:left;" >  
	            		<form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                		<input type="submit" value="Cancel Crop" style="width:100px; height:30px; margin-top: -39px; margin-left: 60px;"   />
	            		</form>
	        </div>  
	            </form>
	        </div>
